...
const LiveData=()=>{
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('cricketinformer-production.up.railway.app/live'); // Replace with your API endpoint
  ...
  return (
    <>
    <h1 className='text-center mt-14 font-bold text-slate-500 text-2xl '>Live Matches's Score</h1>
